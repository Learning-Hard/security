 ...
 * \
 */
public class SmsCodeFilter extends OncePerRequestFilter implements InitializingBean {/* 一次请求只通过一次filter，而不需要重复执行 */
...
//                validate(new ServletWebRequest(request));
    ...
    private ValidateCodeType validate(ServletWebRequest request) {
        ...
        /* 获取session中的验证码 */
        String validateCode = (String) sessionStrategy.getAttribute(request, SmsCodeFilter.ALREADY_FILTERED_SUFFIX);
        return null;
    }
